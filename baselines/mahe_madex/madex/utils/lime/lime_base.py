...
class LimeBase(object):
    ...
    def explain_instance_with_data(
        ...
        """
        # data_copy = copy.deepcopy(neighborhood_data)
        ...
        all_pred = easy_model.predict(neighborhood_data[:, used_features])

        mse = mean_squared_error(labels_column, all_pred, sample_weight=weights)
