...
class BertTokenizer(object):
    ...
    def __init__(
        ...
        self.do_wordpiece_tokenize = True
        # if not self.do_wordpiece_tokenize:
        #    print('[*] Wordpiece tokenization is turned off')

    def tokenize(self, text, use_wp=True, return_mapping=False):
    ...
    def convert_tokens_to_ids(self, tokens):
        ...
        ids = []
        # strict = self.do_wordpiece_tokenize
        for token in tokens:
            # if strict:
